...
describe 'Usuário cadastra um fornecedor' do
  ...
  it 'com CNPJ inválido 1 a 13 dígitos' do
    #Arrange
  ...
  it 'com CNPJ com letras' do
    ...
    click_on 'Enviar'
    #Assert
    expect(page).to have_content 'CNPJ campo deve ser composto de números'
  end
end
